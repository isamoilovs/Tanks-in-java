...
public class Bullet {
    ...
    public Bullet(TextureAtlas atlas) {
        ...
        this.bulletRectangle.setPosition(position.x - GameConsts.BULLET_WIDTH / 4, position.y - GameConsts.BULLET_WIDTH/4);
        this.bulletRectangle.setWidth(GameConsts.BULLET_WIDTH/2);
        this.bulletRectangle.setHeight(GameConsts.BULLET_WIDTH/2);
